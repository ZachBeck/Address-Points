...
def wasatchCounty():
    ...
    #wasatchCoAddFLDS = ['FullName', 'FullAdd', 'Building', 'UnitType', 'UnitID', 'FeatureTyp', 'SiteAddID', 'StreetType', 'PointType', 'SHAPE@']
    ...
    #                 if sName in fixDict:
    #                     sName = fixDict[sName]
    #                 if sName.isdigit() and sType != None:
    #                     sType = ''
    #
